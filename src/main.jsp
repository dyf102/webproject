   ...
   <div class="page-container">
	...
	<%
		...
		Connection m_con = null;
            	...
            	String sql = "SELECT i.PHOTO_ID FROM POPULARITY p,IMAGES i WHERE p.PHOTO_ID =i.PHOTO_ID AND COUNT_NUM IN (SELECT * FROM (SELECT DISTINCT COUNT_NUM FROM POPULARITY  ORDER BY COUNT_NUM DESC) WHERE ROWNUM <=5 )";
